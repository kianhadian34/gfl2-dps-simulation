...
- `npm test` → 129/129 pass (92 base + 7 U5 boss-Stability + 2 U7/U8 status-timing + 2 U14 boss-DEF + 10 Ammo Weakness Upgrade + 4 Phase-elemental-weakness U15b + 4 weakness-matching U15a + 1 AWU persistence + 5 weakness-stability U15 + 3 partial-match U15a − 1 premise-based 'phase countering ×1.2/×0.8' test removed 2026).
