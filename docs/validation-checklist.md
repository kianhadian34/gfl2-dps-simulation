...
| Max-Confectance Ultimate: +1 SB II stack → **4 total** and +1 Support Action quota → **4 that turn** (turn-scoped; resets to the normal 3 at next round start) | **Validated** (in-game 2026) | both bonuses directly confirmed in-game; regression: 4 SB II stacks consumed by exactly 4 Supports that turn (no 5th), normal turn still capped at 3 |
