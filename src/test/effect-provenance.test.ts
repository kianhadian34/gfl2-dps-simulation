...
test("provenance: support-scoped custom doll's support hit reports the passive source; normal hit unaffected", () => {
  const c: CharacterDef = {
    ...
    skills: abilities({
      ...
      active2: { id: "pv_a2", name: "-", type: "active", element: null, multiplier: 0, stabDamage: 0, cooldown: 1, confectanceCost: 0 },
      ultimate: { id: "pv_ult", name: "-", type: "ultimate", element: null, multiplier: 0, stabDamage: 0, cooldown: 0, confectanceCost: 3 },
      support: { id: "pv_sup", name: "Support", type: "support", element: null, multiplier: 0.9, stabDamage: 0, cooldown: 0, confectanceCost: 0 },
    }),
    passive: {
      id: "pv_passive",
...
test("provenance: applying doll status source is used for the bonus's label (damage_up_ii via V5-style application not executed; status source still surfaced)", () => {
  ...
  const c: CharacterDef = {
    ...
    skills: abilities({
      ...
      active2: { id: "pv2_a2", name: "-", type: "active", element: null, multiplier: 0, stabDamage: 0, cooldown: 1, confectanceCost: 0 },
      ultimate: { id: "pv2_ult", name: "-", type: "ultimate", element: null, multiplier: 0, stabDamage: 0, cooldown: 0, confectanceCost: 3 },
    }),
