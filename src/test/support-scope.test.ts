...
function scopeChar(id: string, statusSpec: StatusApplySpec): CharacterDef {
  return {
    ...
    skills: abilities({
      basic: { id: `${id}_basic`, name: "Hit", type: "basic", element: null, multiplier: 1.0, stabDamage: 0, cooldown: 0, confectanceCost: 0, appliesStatuses: [statusSpec] },
      ...
      support: { id: `${id}_support`, name: "Support", type: "support", element: null, multiplier: 0.9, stabDamage: 0, cooldown: 0, confectanceCost: 0 },
    }),
    passive: {
      id: `${id}_passive`,
      name: "-",
